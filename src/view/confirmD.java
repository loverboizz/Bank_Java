...
public class confirmD extends JFrame {
	...
	public void confirm1(String STD, String Amount) throws HeadlessException {
		...
		this.Amount=Amount;
		try {
			confirmD frame = new confirmD(STD, Amount);
	 ...
	 * Create the frame.
	 */
	public confirmD(String STD, String Amount) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(new Controller().checkPin(STD, hashPin)) {
					if(new Controller().Deposit(STD, Amount)) {
