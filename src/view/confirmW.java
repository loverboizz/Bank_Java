...
public class confirmW extends JFrame {

	private JPanel contentPane;
	private String STD, Amount;
	private JPasswordField pw;
	
	public void confirm1(String STD, String Amount) throws HeadlessException {
		this.STD = STD;
		this.Amount=Amount;
		try {
			confirmW frame = new confirmW(STD, Amount);
	 ...
	 * Create the frame.
	 */
	public confirmW(String STD, String Amount) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(new Controller().checkPin(STD, hashPin)) {
					if(new Controller().Withdraw(STD, Amount)) {
